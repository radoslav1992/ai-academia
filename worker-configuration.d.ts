/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9ff171dd7fb372d8b99ee21f2a94ec6f)
// Runtime types generated with workerd@1.20260625.1 2025-06-01 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	NEWSLETTER_EMAIL: SendEmail;
	ASSETS: Fetcher;
	SITE_NAME: "AI Академия";
	FROM_EMAIL: "bulletin@ai-akademia.bg";
	FROM_NAME: "AI Академия";
	PUBLIC_SITE_URL: "https://ai-akademia.bg";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_NAME" | "FROM_EMAIL" | "FROM_NAME" | "PUBLIC_SITE_URL">> {}
}
